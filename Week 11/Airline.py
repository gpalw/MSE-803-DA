...
# Construct the input and output data of LSTM: Use one-step prediction, taking the value of each moment as input and the value of the next moment as output
...
# Evaluate LSTM: Since LSTM's prediction is missing one sample, compare y_test[1:]
evaluate_model(y_test[1:], y_pred_lstm, "LSTM")
